...
top_10_countries = px.bar(top_10_countries, x=top_10_countries.values, y=top_10_countries.index, orientation='h', labels={'index':'','x':'Shark attacks'}, color = 'Country', hover_data=["Count"])
